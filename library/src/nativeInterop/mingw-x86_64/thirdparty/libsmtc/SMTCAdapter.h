...
extern "C"{
	...
	SMTC_API void setOnStop(void (*)(void*));
	SMTC_API void setOnNext(void (*)(void*));
	...
	SMTC_API void setCallbackData(void*);
	SMTC_API void revokeCallbacks();

	SMTC_API void setOnSeek(void (*)(long long, void*));
	...
	SMTC_API void setThumbnail(const wchar_t*, bool);
